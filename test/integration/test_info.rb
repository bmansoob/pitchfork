...
class InfoTest < Pitchfork::IntegrationTest
  ...
  def test_live_workers_count_if_after_worker_fork_does_not_complete
    ...
    # bundle exec megatest test/integration/test_info.rb fails with:
    #  Expected: "{workers_count: 20, live_workers_count: 1}"
    #  Actual: "{workers_count: 20, live_workers_count: 20}"
